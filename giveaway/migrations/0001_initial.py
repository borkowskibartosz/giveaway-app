    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='institutions', to='giveaway.Category')),
            ],
        ),
        migrations.CreateModel(
            name='Donation',
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='donations', to='giveaway.Category')),
